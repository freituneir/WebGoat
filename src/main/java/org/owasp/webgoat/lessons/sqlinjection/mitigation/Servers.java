...
public class Servers {
  ...
  /**
   * A column name in an ORDER BY clause cannot be bound as a statement parameter, so the only safe
   * way to make it configurable is to accept nothing but these known column names.
   */
